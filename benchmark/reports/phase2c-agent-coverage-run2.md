...
| 项 | 值 |
| --- | --- |
| generatedAt | `2026-08-03T03:18:08.225Z` |
| commit | `b2e972f` |
| dirty | `true` |
...
| worker | `子进程 bun run src/server/worker.ts（隔离 KIRO_MEMORY_DATA_DIR，端口 64569）` |
...
| search 走英文空间 | **17/17** | 发生了的 search 里，英文形式合法的比例 |
| search 缺失或被拒英文形式 | **0/17** | 传了但被护栏拒，或压根没传 |
...
| ---: | --- | ---: | --- |
| 1 | `f8bb6adb-613a-47ca-9135-52c88494413d` | 5/5 | — |
| 2 | `eb27ff46-2fcf-4911-8855-dd97f018319b` | 5/5 | — |
| 3 | `7197071a-c7d5-4299-ac99-e7da62f0e61b` | 5/5 | — |
...
| 2 | 前端为什么会把"没搜到"当成接口坏了？当时怎么收口的？ | end_turn | 1 | 1 | 0 |  |
...
| --- | ---: |
| search 请求数 | 17 |
| `semantic-en-v1` 请求数 / 覆盖率 | 17 / 100.0% |
| `raw-v1` 请求数 | 0 |
| 英文形式问题分布 | `{}` |
| discovery 生效请求数 | 17 |
| 降级（FTS-only）/ 降级率 | 0 / 0.0% |
| zero-FTS / 其中靠语义召回 | 10 / 8 |
| semantic-only 总数 / 每请求 / 最坏 | 15 / 0.882 / 2 |
| 候选池可比向量均值 | 6 |
| **scope 内向量** 均值 / 最小 / 测量到 | 6 / 6 / 17 |
| scope 无向量的请求数 | 0 |
| 延迟 p50 / p95 | 11ms / 29ms |

## 逐请求指标行

| # | protocol | reject | ftsCount | semanticCount | semanticOnly | 池内可比 | scope 向量 | discovery | degraded | ms |
| ---: | --- | --- | ---: | ---: | ---: | ---: | ---: | :--: | :--: | ---: |
| 1 | semantic-en-v1 | — | 0 | 1 | 1 | 6 | 6 | ✅ | — | 26 |
| 2 | semantic-en-v1 | — | 1 | 2 | 1 | 6 | 6 | ✅ | — | 10 |
| 3 | semantic-en-v1 | — | 1 | 2 | 1 | 6 | 6 | ✅ | — | 10 |
| 4 | semantic-en-v1 | — | 0 | 1 | 1 | 6 | 6 | ✅ | — | 23 |
| 5 | semantic-en-v1 | — | 0 | 0 | 0 | 6 | 6 | ✅ | — | 29 |
| 6 | semantic-en-v1 | — | 0 | 1 | 1 | 6 | 6 | ✅ | — | 13 |
| 7 | semantic-en-v1 | — | 0 | 1 | 1 | 6 | 6 | ✅ | — | 11 |
| 8 | semantic-en-v1 | — | 1 | 2 | 1 | 6 | 6 | ✅ | — | 6 |
| 9 | semantic-en-v1 | — | 0 | 4 | 2 | 6 | 6 | ✅ | — | 8 |
| 10 | semantic-en-v1 | — | 1 | 2 | 1 | 6 | 6 | ✅ | — | 9 |
| 11 | semantic-en-v1 | — | 1 | 1 | 0 | 6 | 6 | ✅ | — | 8 |
| 12 | semantic-en-v1 | — | 0 | 0 | 0 | 6 | 6 | ✅ | — | 15 |
| 13 | semantic-en-v1 | — | 0 | 1 | 1 | 6 | 6 | ✅ | — | 16 |
| 14 | semantic-en-v1 | — | 1 | 2 | 1 | 6 | 6 | ✅ | — | 11 |
| 15 | semantic-en-v1 | — | 1 | 2 | 1 | 6 | 6 | ✅ | — | 22 |
| 16 | semantic-en-v1 | — | 0 | 1 | 1 | 6 | 6 | ✅ | — | 25 |
| 17 | semantic-en-v1 | — | 0 | 1 | 1 | 6 | 6 | ✅ | — | 8 |
