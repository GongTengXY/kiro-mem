...
const messages = {
  zh: {
    ...
    compressionStartupTimeoutMs: '? ACP 握手超时 (毫秒, 范围 5000-120000)',
  ...
  en: {
    ...
    compressionStartupTimeoutMs: '? ACP handshake timeout (ms, 5000-120000)',
    ...
    startupTimeoutLabel: 'Handshake timeout (ms):',
